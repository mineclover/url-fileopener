...
import { setRegistry, processRegistryPath } from './registry.js';
...
const register = async (options) => {
    const { appName, command, protocol, terminal } = options;
    ...
    const { commandRegistry, registry } = getRegistry(protocol);
